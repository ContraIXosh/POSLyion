...
namespace POSLyion
{
    public partial class formVentas : Form
    {
        ...
        private void CrearNuevoTicket()
        {
            ...
            Button nuevoTicket = new Button();
            nuevoTicket.UseVisualStyleBackColor = true;
            nuevoTicket.Text = "Ticket " + tlp_tickets.ColumnCount;
            nuevoTicket.Size = new Size(100, 50); // Ajustar el tamaño del botón

            // Añadir el botón al TableLayoutPanel
            tlp_tickets.Controls.Add(nuevoTicket, tlp_tickets.ColumnCount, 0);
